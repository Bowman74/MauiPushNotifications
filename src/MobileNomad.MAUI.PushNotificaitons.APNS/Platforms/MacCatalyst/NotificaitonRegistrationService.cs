...
/// <summary>
/// Provides an implementation of <see cref="NotificationRegistrationServiceBase"/> for registering and unregistering Mac Catalyst devices with Azure Notification Hubs using APNS.
/// </summary>
public class NotificationRegistrationService : NotificationRegistrationServiceBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NotificationRegistrationService"/> class for Mac Catalyst.
    /// </summary>
    ...
    {
        // Set the device ID using the Mac Catalyst device's unique identifier.
        _deviceId = UIDevice.CurrentDevice.IdentifierForVendor.AsString();
    }

    /// <summary>
    /// Creates an <see cref="Installation"/> object for the current Mac Catalyst device using the provided registration message.
    /// </summary>
